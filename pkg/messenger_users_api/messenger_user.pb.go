...
func (*GetUserRequest) Descriptor() ([]byte, []int) {
	return file_api_messenger_user_proto_rawDescGZIP(), []int{4}
}
...
func (x *GetUserResponse) Reset() {
	*x = GetUserResponse{}
	mi := &file_api_messenger_user_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserResponse) Descriptor() ([]byte, []int) {
	return file_api_messenger_user_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetUserResponse_User) Reset() {
	*x = GetUserResponse_User{}
	mi := &file_api_messenger_user_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserResponse_User) Descriptor() ([]byte, []int) {
	return file_api_messenger_user_proto_rawDescGZIP(), []int{5, 0}
}
...
const file_api_messenger_user_proto_rawDesc = "" +
	"\n" +
	"\x18api/messenger_user.proto\x12\x04user\"\xa9\x01\n" +
	...
	"\auser_id\x18\x03 \x01(\x05R\x06userId\"\xfe\x01\n" +
	...
	"\x05phone\x18\x06 \x01(\tR\x05phone2\xb0\x01\n" +
	"\vUserService\x127\n" +
	"\n" +
	"CreateUser\x12\x13.user.CreateRequest\x1a\x14.user.CreateResponse\x120\n" +
...
var file_api_messenger_user_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_api_messenger_user_proto_goTypes = []any{
	...
	(*GetUserResponse_User)(nil), // 6: user.GetUserResponse.User
}
var file_api_messenger_user_proto_depIdxs = []int32{
	6, // 0: user.GetUserResponse.users:type_name -> user.GetUserResponse.User
	...
	1, // 4: user.UserService.CreateUser:output_type -> user.CreateResponse
...
func file_api_messenger_user_proto_init() {
	...
	file_api_messenger_user_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
